...
void draw() {
  ...
  translate(x, y);
  // generate random color from 0-60 (red-yellow) or 330-360 (magenta-red)
  if (random(1) < 0.5) {
    base_c = color(random(0, 60), random(50, 65), random(90, 100), 95);
  } else {
    base_c = color(random(330, 360), random(50, 65), random(90, 100), 95);
  }
